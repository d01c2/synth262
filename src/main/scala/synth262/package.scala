...
import synth262.error.NoEnvVarError
...
/** base project directory root */
val BASE_DIR = sys.env.getOrElse("SYNTH262_HOME", throw NoEnvVarError)
...
val SRC_DIR = s"$BASE_DIR/src/main/scala/synth262"
