...
import synth262.compiler.Compiler
import synth262.error.NotSupported.*
import synth262.error.{NotSupported => NSError}
import synth262.extractor.Extractor
...
trait Synth262Test extends funsuite.AnyFunSuite with BeforeAndAfterAll {
  // set test mode
  TEST_MODE = true
